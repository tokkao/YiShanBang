 ...
 * Describe:查看购物车弹窗
 */
public class VentureShopCartPopupWindow extends PopupWindow {
    ...
    public VentureShopCartPopupWindow(Activity activity, String mShopId) {
        super(activity);
    ...
    private void clearShoppingCar() {
        ...
        BaseOkHttpClient.newBuilder()
                ...
                .url(NetUrlUtils.VENTURE_SHOP_CLEAR_CART)
                .post()
    ...
    private void updateShoppingCar(String cartId, int goodsNum) {
        BaseOkHttpClient.newBuilder()
                ...
                .url(NetUrlUtils.VENTURE_SHOP_UPDATE_CART_COUNT)
                .post()
                .build().enqueue(mContext, new BaseCallBack<String>() {
            @Override
            public void onSuccess(String json, String msg) {
