 ...
 * Describe:聊天赴约用户列表adapter
 */
public class IMServiceUserListAdapter extends AFinalRecyclerViewAdapter<IMNotifyUserListBean> {

    public IMServiceUserListAdapter(Context ctx) {
        super(ctx);
    }
    ...
    public class CommonViewHolder extends BaseRecyclerViewHolder {
        ...
        private void setContent(IMNotifyUserListBean mNotifyUserListBean, int position) {
