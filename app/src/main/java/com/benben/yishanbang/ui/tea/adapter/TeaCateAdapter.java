 ...
 * 奶茶分类
 */
public class TeaCateAdapter extends AFinalRecyclerViewAdapter<TeaShopGoodsInfoBean.MilkTeaGoodsVosBeanX> {

    public TeaCateAdapter(Context ctx) {
        super(ctx);
    }
    ...
    public class CommonViewHolder extends BaseRecyclerViewHolder {
        ...
        public void setContent(int position, TeaShopGoodsInfoBean.MilkTeaGoodsVosBeanX data) {
