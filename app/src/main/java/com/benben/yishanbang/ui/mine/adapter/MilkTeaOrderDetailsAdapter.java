 ...
 */
public class MilkTeaOrderDetailsAdapter extends AFinalRecyclerViewAdapter<MilkTeaDetailsBean.MilkTeaOrderVoBean.MilkTeaOrderGoodsVosBean> {
    private Context mContext;


    public MilkTeaOrderDetailsAdapter(Context ctx) {
        super(ctx);
    ...
    public class CommonViewHolder extends BaseRecyclerViewHolder {
        ...
        private void setContent(MilkTeaDetailsBean.MilkTeaOrderVoBean.MilkTeaOrderGoodsVosBean milkTeaOrderGoodsVosBean, int position) {
