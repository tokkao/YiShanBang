...
import com.benben.yishanbang.ui.mine.fragment.MilkTeaOrderFragment;
 ...
 * Describe: //奶茶订单
 */
public class MilkTeaOrderActivity extends BaseActivity {
    ...
    protected void initData() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            MilkTeaOrderFragment milkTeaOrderFragment = new MilkTeaOrderFragment();
            milkTeaOrderFragment.setArguments(bundle);
            mFragmentList.add(milkTeaOrderFragment);
        }

        mTabEntities.add(new TabEntityBean("全部", 0, 0));
        mTabEntities.add(new TabEntityBean("未完成", 0, 0));
