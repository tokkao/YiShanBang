...
package com.benben.yishanbang.widget.progressbar;
...
public class CircleProgressbar extends AppCompatTextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mArcRect.set(bounds.centerX() - outerRadius+outLineWidth, bounds.centerY() - outerRadius+outLineWidth,
                bounds.centerX() + outerRadius-outLineWidth, bounds.centerY() + outerRadius-outLineWidth);
