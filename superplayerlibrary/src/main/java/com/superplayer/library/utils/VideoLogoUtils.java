...
public class VideoLogoUtils extends AppCompatImageView {
    private float width;
    ...
    public VideoLogoUtils(Context context) {
        this(context, null);
    }
    public VideoLogoUtils(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }


    public VideoLogoUtils(Context context, AttributeSet attrs, int defStyleAttr) {
