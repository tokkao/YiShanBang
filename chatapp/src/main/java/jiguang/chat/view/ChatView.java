...
public class ChatView extends RelativeLayout {
    ...
    private RelativeLayout rlytShop;
    ...
    public void initModule(float density, int densityDpi) {
        ...
        mRechargeBtn = (ImageView) findViewById(R.id.jmui_recharge);
        mChatTitle = (TextView) findViewById(R.id.jmui_title);
        mAtMeBtn = (Button) findViewById(R.id.jmui_at_me_btn);
        rlytShop = (RelativeLayout) findViewById(R.id.rlyt_shop);
        if (densityDpi <= 160) {
    ...
    public void setListeners(View.OnClickListener listeners) {
        ...
        mRechargeBtn.setOnClickListener(listeners);
        rlytShop.setOnClickListener(listeners);
    }
