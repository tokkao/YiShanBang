...
public class JGApplication extends com.activeandroid.app.Application {
    ...
    public static final int BUSINESS_GIFT = 8;
    public static final int BUSINESS_CAKE = 9;
    public static final int BUSINESS_FLOWER = 10;
    public static final int BUSINESS_BEAR = 11;
    public static final int BUSINESS_RING = 12;
