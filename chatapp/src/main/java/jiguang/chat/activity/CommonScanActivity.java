...
public final class CommonScanActivity extends Activity implements View.OnClickListener {
    ...
    @BindView(R2.id.authorize_return)
    ImageView authorize_return;
    private int scanMode;//扫描模型（二维码）

    @BindView(R2.id.common_title_TV_center)
    TextView title;
    @BindView(R2.id.scan_hint)
    TextView scan_hint;
    ...
    void initView() {
        ...
        //构造出扫描管理器
        scanManager = new ScanManager(this, scanPreview, scanContainer, scanCropView, scanLine, scanMode, null);
    }
