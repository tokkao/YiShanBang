...
//        mChatAdapter.initMediaPlayer();
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.jmui_return_btn) {
            ...
            Log.e("chatActivity", "messageList ===jmui_recharge");
            String recharge = "recharge";
            mRxBus.post(recharge);
        } else if (i == R.id.rlyt_shop) {
            Log.e("chatActivity", "messageList ===rlyt_shop");
            String shop = "venture_shop";
            mRxBus.post(shop);
        }
    }
    ...
    public void onEventMainThread(ImageEvent event) throws IOException {
        ...
        switch (event.getFlag()) {
            ...
            case JGApplication.BUSINESS_CAKE://cake
                ...
                JMessageClient.sendMessage(cake);
                handleSendMsg(cake);
                break;
            case JGApplication.BUSINESS_FLOWER://flower
                ...
                JMessageClient.sendMessage(flower);
                handleSendMsg(flower);
                break;
            case JGApplication.BUSINESS_BEAR://bear
                ...
                JMessageClient.sendMessage(bear);
                handleSendMsg(bear);
                break;
            case JGApplication.BUSINESS_RING://ring
                ...
                JMessageClient.sendMessage(ring);
                handleSendMsg(ring);
                break;
            default:
                break;
